...
# # Write to file
# write.csv(dl_orig,
#           "data/orig-downloads/herp-data-download.csv",
#           row.names = FALSE)

dat_orig <- read.csv("data/orig-downloads/herp-data-download.csv")
...
# write.csv(dat_all,
#           "data/out/herp-series-allyeses-thru2025.csv",
#           row.names = FALSE)
...
# Write to file (keep commented out so we don't accidentally overwrite)
# write.csv(dat_14,
#           "data/out/herp-series-prior14-thru2025.csv",
#           row.names = FALSE)
...
# Write to file (keep commented out so we don't accidentally overwrite)
# write.csv(dat_7,
#           "data/out/herp-series-prior7-thru2025.csv",
#           row.names = FALSE)
