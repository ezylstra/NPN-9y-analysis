# Download, process herpetofauna data
# 11 Feb 2026
...
#   functional_types = c("Amphibian", "Reptile"),
#   years = 2011:2025
# ) %>% data.frame()
# 
# # Write to file
# write.csv(dl_orig,
#           "data-download-2025/data-original/herp-data-download.csv",
#           row.names = FALSE)

dat_orig <- read.csv("data-download-2025/data-original/herp-data-download.csv")
...
# 5. Use anything other than calendar year for herps? -------------------------#
...
# write.csv(dat_all,
#           "data-download-2025/data-out/herp-series-allyeses-thru2025.csv",
#           row.names = FALSE)
...
# Write to file (keep commented out so we don't accidentally overwrite)
# write.csv(dat_14,
#           "data-download-2025/data-out/herp-series-prior14-thru2025.csv",
#           row.names = FALSE)
...
# Write to file (keep commented out so we don't accidentally overwrite)
# write.csv(dat_7,
#           "data-download-2025/data-out/herp-series-prior7-thru2025.csv",
#           row.names = FALSE)
